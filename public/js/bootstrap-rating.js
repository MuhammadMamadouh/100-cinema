(function ($) {
  ...
  function createRatingEl($input, options) {
    // Inline option
    if (options.inline) {
      var $ratingEl = $('<span class="rating-inputs"></span>');
    } else {
      var $ratingEl = $('<div class="rating-inputs"></div>');
    }
    ...
    for (var i = options.min; i <= options.max; i++) {
      $ratingEl.append('<i class="btn btn-default btn-xs ' + options.iconLib + '" data-value="' + i + '"></i>');
    }
