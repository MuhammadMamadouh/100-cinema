                                    ...
                                    <article class="row">
                                        <div class="col-md-2 col-sm-2 hidden-xs">
                                            <figure class="thumbnail">
                                                <img class="img-responsive" src="{{asset('public/test/images/amanda1.jpg')}}"
                                                     alt="amanda cerny">
                                        ...
                                        <textarea class="form-control form-group" id="commentBox"
                                                  placeholder="What are you doing right now?"></textarea>
                                                            <button type="submit" class="btn btn-success green pull-right"><i
                                        ...
                                        <div class="col-md-2 col-sm-2 hidden-xs">
                                            <figure class="thumbnail">
                                                <img class="img-responsive"
                                                     ...
                                                     alt="amanda cerny">
                                                <figcaption class="text-center"> <a href="#">Amanda Cerny</a> </figcaption>
                                            </figure>
                                        </div>
                                        <div class="col-md-10 col-sm-10">
                                            <div class="panel panel-default arrow left">
                                                <div class="panel-body">
                                                    <header class="text-left">
                                                        <div class="comment-user"><i class="fa fa-user"></i> <a href="#">Amanda Cerny</a>
                                                        </div>
                                        ...
                                        <div class="col-md-2 col-sm-2 hidden-xs">
                                            <figure class="thumbnail">
                                                <img class="img-responsive img-circle"
                                                     src="{{asset('public/test/images/amanda3.jpg')}}" alt="amanda cerny">
                                                <figcaption class="text-center"> <a href="#">Amanda Cerny</a> </figcaption>
                                            </figure>
                                        </div>
                                        <div class="col-md-10 col-sm-10">
