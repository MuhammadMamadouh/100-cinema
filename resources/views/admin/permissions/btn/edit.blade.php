    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => ['permissions.update', $id], 'method'=> 'put','id'=>'frm-update-'.$id]) !!}
                <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">

                    <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
                        <input type="text" name="name" class="form-control input" value="{{ $key}}"
                               placeholder="key">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback {{ $errors->has('display_name') ? 'has-error' : '' }}">
                        <input type="text" name="display_name" class="form-control input" value="{{ $table_name}}"
