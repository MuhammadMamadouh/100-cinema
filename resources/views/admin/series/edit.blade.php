    ...
    <div class="box col-md-9">
        ...
        <div class="box-body">
            ...
            <div class="form-group has-feedback {{ $errors->has('email') ? 'has-error' : '' }}">
                <input type="email" name="email" class="form-control" value="{{ $movie->email }}"
            ...
            <div class="form-group has-feedback {{ $errors->has('country') ? 'has-error' : '' }}">
                {!! Form::text('country',$movie->country,['class'=>'form-control','placeholder'=>trans('adminlte::adminlte.country') ]) !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('site') ? 'has-error' : '' }}">
                {!! Form::text('site',$movie->site,['class'=>'form-control','placeholder'=>trans('adminlte::adminlte.site') ]) !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('short_bio') ? 'has-error' : '' }}">
                {!! Form::text('short_bio',$movie->short_bio,['class'=>'form-control','placeholder'=>trans('adminlte::adminlte.short_bio') ]) !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('about') ? 'has-error' : '' }}">
                {!! Form::textarea('about',$movie->about,['class'=>'form-control','placeholder'=>trans('adminlte::adminlte.about') ]) !!}
            ...
            @if(!empty($movie->image))
                <img src="{{\Storage::url($movie->image)}}" style="height: 100px; width:100px">
            @endif
