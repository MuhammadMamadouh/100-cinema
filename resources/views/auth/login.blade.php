...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <!-- /.social-auth-links -->
            <div class="social-auth-links col-md-4 text-center">
                <div class="card">
                    <br> <br>
                    <h3 class="h3">- OR -</h3>
                    ...
                    <div class="card-body">
                        ...
                        <a href="login/facebook" class="btn btn-block btn-primary btn-facebook"><i
                                    class="fa fa-facebook"></i> Sign in using
                            Facebook</a>
                        <a href="login/google" class="btn btn-block btn-danger btn-google"><i
