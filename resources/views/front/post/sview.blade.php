                                            ...
                                            <div class="panel panel-default arrow left">
                                                <div class="panel-body">
                                                    <div class="comment-post">
                                                        {!! Form::open(['url' => route('addComment', $post->id), 'method'=> 'post', 'id'=> 'commcomment!!}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#commentBox').on('keypress', function (e) {
                if (e.keyCode == 13) {
                    e.preventDefault();
                    var form = $('#add-commcomment                    var data = form.serialize();
        ...
        $('body').delegate('.commcommentue .delete-commcommentclick', function (e) {
            e.preventDefault();
        ...
        $('body').delegate('.commcommentue .edit-commcommentclick', function () {
            var id = $(this).attr('id');
            console.log(id);
            $('#frm-update-' + id).on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: (function (results) {
                        ...
                        if (results.comment) {
                            $('#commcommentt-' + id).html(results.comment);
                        }
                    }),
                    error: (function (results) {
                        $.each(results.responseJSON.errors, function (index, val) {
