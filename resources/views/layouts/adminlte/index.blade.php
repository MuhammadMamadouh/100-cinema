            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="media">
                            ...
                            @auth
                                @if(Auth::user('admin')->image)
                                    <img src="{{asset(Storage::url(Auth::user('admin')->image))}}" alt="User Avatar"
                                         class="img-size-50 mr-3 img-circle">
                                @else
                                    <img src="{{asset('public/adminlte/dist/img/user1-128x128.jpg')}}" alt="User Avatar"
                                         class="img-size-50 mr-3 img-circle">
                                @endif
                            @elseauth
                                <img src="{{asset('public/adminlte/dist/img/user1-128x128.jpg')}}" alt="User Avatar"
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="{{asset('public/adminlte/dist/img/user8-128x128.jpg')}}'" alt="User Avatar"
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2017 -{{Carbon\carbon::now()->year}} <a
