            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="row person_details">
                        ...
                        <p>My name is Bernard Shelly. I am 32 years old. Lorem ipsum dolor sit amet, consectetur ascing
                            elits, sed do eiusmod tempor incidunt ut labore et dolore mafgna aliqua. Ut enim ad mini
                            vniam quis nerci, tation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis autes
                            irure dolor in reprehenderit in etrs voluptate velit esse cillum dolore eu fugiat nulla
                            pariatur. The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for
                            those interested.</p>
            ...
            <div class="row">
                <div class="col-md-6 wow fadeInUp animated">
                    <div class="skill_text">
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Loren Ipsum has
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="left_contact_details wow fadeInUp animated">
                        ...
                        <p>There are many variations of passages of Lorem Ipsum available, but the et majori have
                            suffered alteration in some form, by injected humour, Domised words which don't look even
                    ...
                    <div class="contact_from_area wow fadeInUp animated">
                        ...
                        <div class="row">
                            <form action="contact_process.php" method="post" id="contactForm">
                                ...
                                <div class="form-group col-md-12">
                                    <button class="btn btn-default contact_btn" type="submit"><span>Send Massage</span>
                                    </button>
                                </div>
                            </form>
                            <div id="success">
